 ...
 * source access.
 *
 * @see \yiiframe\workflow\base\WorkflowBaseObject
 */
class Workflow extends WorkflowBaseObject implements WorkflowInterface
{
	...
	/**
	 * @see \yiiframe\workflow\base\WorkflowInterface::getInitialStatusId()
	 */
	...
	/**
	 * @see \yiiframe\workflow\base\WorkflowInterface::getInitialStatus()
	 */
	...
	/**
	 * @see \yiiframe\workflow\base\WorkflowInterface::getAllStatuses()
	 */
