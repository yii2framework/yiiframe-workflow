...
interface WorkflowInterface
{
	 ...
	 * 
	 * @return \yiiframe\workflow\base\StatusInterface the initial status instance
	 * @throws \yiiframe\workflow\base\WorkflowException when no source component is available
	 */
	public function getInitialStatus();
	/**
	 * Returns an array containing all Status instances belonging to this workflow.
	 * 
	 * @return \yiiframe\workflow\base\StatusInterface[]  status list belonging to this workflow
	 * @throws \yiiframe\workflow\base\WorkflowException when no source component is available
	 */
