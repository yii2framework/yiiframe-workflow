...
use yiiframe\workflow\events\IEventSequence;
use yiiframe\workflow\validation\WorkflowScenario;
use yiiframe\workflow\events\WorkflowEvent;
 ...
 * 
 * <pre>
 * use yiiframe\workflow\base\SimpleWorkflowBehavior;
 *
...
class SimpleWorkflowBehavior extends Behavior
{
	 ...
	 * configured.
	 */
	const DEFAULT_SOURCE_CLASS = 'yiiframe\workflow\source\file\WorkflowFileSource';
	/**
	 * Name of the class used to instantiate the default event sequence if not 
	 * configured.
	 */
	const DEFAULT_EVENT_SEQUENCE_CLASS = 'yiiframe\workflow\events\BasicEventSequence';
	/**
	 ...
	 * `yiiframe\workflow\base\IStatusIdConverter` interface.
	 */	
	 ...
	 * `yiiframe\workflow\base\IStatusAccessor` interface.
	 */	
	 ...
	 * 
	 * @throws \yiiframe\workflow\base\WorkflowException if the status attribute could not be converted into a Status object
	 */
	 ...
	 * - index = 1 : an array of [[\yiiframe\workflow\events\WorkflowEvent]] instances (the event sequence) that 
	 ...
	 * 
	 * @return \yiiframe\workflow\source\IWorkflowSource the workflow source component instance used by this behavior
	 */
	 ...
	 * @return NULL|\yiiframe\workflow\base\IStatusAccessor the status accessor component used bu the behavior
