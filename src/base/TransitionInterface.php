...
interface TransitionInterface
{
	 ...
	 *
	 * @return \yiiframe\workflow\base\StatusInterface the Status instance this transition ends to
	 */
	public function getEndStatus();
	/**
	 * Returns the Status instance that is the starting point fo the transition.
	 *
	 * @return \yiiframe\workflow\base\StatusInterface the Status instance this transition starts from
	 */
