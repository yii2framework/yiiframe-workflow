...
class Status extends WorkflowBaseObject implements StatusInterface
{
	...
	/**
	 * 
	 * @see \yiiframe\workflow\base\StatusInterface::getTransitions()
	 */
	...
	/**
	 * @see \yiiframe\workflow\base\StatusInterface::getWorkflow()
	 */
	...
	/**
	 * @see \yiiframe\workflow\base\StatusInterface::isInitialStatus()
	 */	
