...
interface StatusInterface
{
	 ...
	 * 
	 * @return \yiiframe\workflow\base\Transition[] the list of out-going transitions for this status. 
	 */
	public function getTransitions();
	/**
	 * Returns the workflow instance this status belongs to
	 * @return \yiiframe\workflow\base\Workflow the workflow instance
	 */
