...
class WorkflowEvent extends ModelEvent
{
	 ...
	 * 
	 * @return \yiiframe\workflow\base\Status the start status involved in this event
	 */
	 ...
	 * 
	 * @return \yiiframe\workflow\base\Status the end status involved in this event
	 */
	 ...
	 * 
	 * @return \yiiframe\workflow\Transition the transition involved in this event or NULL if no
	 * transition is available (e.g. EnterWorkflow, LeaveWorkflow)
	 * @see \yiiframe\workflow\base\Transition
	 */
