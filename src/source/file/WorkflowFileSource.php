<?php
namespace yiiframe\workflow\source\file;
...
use yiiframe\workflow\base\Status;
use yiiframe\workflow\base\Workflow;
use yiiframe\workflow\base\WorkflowException;
use yiiframe\workflow\source\IWorkflowSource;
...
class WorkflowFileSource extends BaseObject implements IWorkflowSource
{
	 ...
	 */
	const DEFAULT_WDLOADER_CLASS = '\yiiframe\workflow\source\file\PhpClassLoader';
	/**
	 *
	 * @var string|array|\yiiframe\workflow\source\file\WorkflowDefinitionLoader The workflow definition loader used by this
	 ...
	 *
	 * If this attribute is not set then a default object of type `\yiiframe\workflow\source\file\PhpClassLoader` is used.
	 */
	...
	/**
	 * @var \yiiframe\workflow\base\WorkflowInterface[] list of workflow instances indexed by workflow id
	 */
	private $_w = [];
	/**
	 * @var \yiiframe\workflow\base\StatusInterface[] list status instances indexed by their id
	 */
	private $_s = [];
	/**
	 * @var \yiiframe\workflow\base\TransitionInterface[] list of out-going Transition instances indexed by the start status id
	 */
	private $_t = [];
	/**
	 ...
	 */
	private $_classMap = [
		self::TYPE_WORKFLOW   => 'yiiframe\workflow\base\Workflow',
		self::TYPE_STATUS     => 'yiiframe\workflow\base\Status',
		self::TYPE_TRANSITION => 'yiiframe\workflow\base\Transition'
	];
	/**
	 * Constructor method.
	 *
	 ...
	 *
	 * @see \yiiframe\workflow\source\IWorkflowSource::getStatus
	 */
	 ...
	 *
	 * @return yiiframe\workflow\base\Workflow|null The workflow instance or NULL if no workflow could be found
	 * @see IWorkflowSource::getTransition()
	 */
	 ...
	 *
	 * @param string $id
	 * @throws \yiiframe\workflow\base\WorkflowException the definition could not be loaded
	 */
	 ...
	 * is set to TRUE.
	 *
	 * @see \yiiframe\workflow\base\SimpleWorkflowBehavior::attach()
	 ...
	 * 
	 * @see \yiiframe\workflow\source\IWorkflowSource::getAllStatuses()
	 */
