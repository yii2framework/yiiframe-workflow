<?php
namespace yiiframe\workflow\source;
...
interface IWorkflowSource
{
	 ...
	 * @return \yiiframe\workflow\base\StatusInterface the status instance or NULL if no status could be found for this id.
	 * @throws \yiiframe\workflow\base\WorkflowException unexpected error
	 */
	 ...
	 * @return \yiiframe\workflow\base\StatusInterface[] list of status. The array key is the status ID
	 * @throws \yiiframe\workflow\base\WorkflowException no workflow is found with this Id
	 */
	 ...
	 * @return \yiiframe\workflow\base\TransitionInterface[] an array containing all out going transition from $statusId. If no such
	 ...
	 * @param mixed $endId
	 * @param mixed $model
	 *  @return \yiiframe\workflow\base\TransitionInterface the transition between start and end status
	 */
	 ...
	 * @return \yiiframe\workflow\base\WorkflowInterface the workflow instance or NULL if no workflow could be found.
	 */
